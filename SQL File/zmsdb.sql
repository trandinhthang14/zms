...
--
-- Table structure for table `tblticvietnam`
--

CREATE TABLE `tblticvietnam` (
  `ID` int(10) NOT NULL,
...
--
-- Dumping data for table `tblticvietnam`
--

INSERT INTO `tblticvietnam` (`ID`, `TicketID`, `NoAdult`, `NoChildren`, `AdultUnitprice`, `ChildUnitprice`, `PostingDate`) VALUES
...
--
-- Indexes for table `tblticvietnam`
--
ALTER TABLE `tblticvietnam`
  ADD PRIMARY KEY (`ID`),
...
--
-- AUTO_INCREMENT for table `tblticvietnam`
--
ALTER TABLE `tblticvietnam`
