...
if (strlen($_SESSION['zmsaid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "insert into  tblticvietnam(TicketID,NoAdult,NoChildren,AdultUnitprice,ChildUnitprice) value('$ticketid','$noadult','$nochildren','$aprice','$cprice')");
        if ($query) {
...
?>
    ...
    <head>
        ...
        <title>Thêm vé sở thú thông thường - Hệ thống quản lý sở thú</title>
                        ...
                        <div class="col-lg-12 col-ml-12">
                            <div class="row">
                                ...
                                <div class="col-12 mt-5">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="header-title">Thêm vé sở thú bình thường</h4>
