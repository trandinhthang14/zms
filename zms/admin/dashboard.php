...
//todays indian adult visitors
 $query=mysqli_query($con,"select sum(NoAdult) as totaladult from tblticvietnam where date(PostingDate)=CURDATE()");
...
//todays indian children visitors
 $query=mysqli_query($con,"select sum(NoChildren) as totalchild from tblticvietnam where date(PostingDate)=CURDATE()");
$result=mysqli_fetch_array($query);
...
//Yesterday indian adult visitors
 $query=mysqli_query($con,"select sum(NoAdult) as totaladulty from tblticvietnam where date(PostingDate)=CURDATE()-1");
$result=mysqli_fetch_array($query);
...
//Yesterday indian children visitors
 $query=mysqli_query($con,"select sum(NoChildren) as totalchildy from tblticvietnam where date(PostingDate)=CURDATE()-1");
$result=mysqli_fetch_array($query);
